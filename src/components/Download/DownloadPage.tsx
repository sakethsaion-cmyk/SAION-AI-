...
const platforms = [
  ...
  },
  {
    ...
    filename: 'SAION-AI-Setup-v1.0.0.exe',
    directLink: `${GITHUB_BASE}/SAION-AI-Setup-v1.0.0.exe`,
  ...
  },
  {
    ...
    filename: 'SAION-AI-v1.0.0.AppImage',
    directLink: `${GITHUB_BASE}/SAION-AI-v1.0.0.AppImage`,
  ...
  },
  {
    ...
    filename: 'SAION-AI-v1.0.0.deb',
    directLink: `${GITHUB_BASE}/SAION-AI-v1.0.0.deb`,
