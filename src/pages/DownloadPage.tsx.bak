...
const platforms = [
  {
    ...
    description:
      'Install directly on your Android phone or tablet. Enable "Unknown sources" in settings if prompted.',
  },
  {
    id: "windows",
    name: "Windows",
    ...
    description:
      "Full desktop experience. Supports Windows 10 and Windows 11, both 64-bit.",
  },
  {
    id: "linux",
    name: "Linux",
    ...
    description:
      "Universal AppImage format — runs on all major Linux distributions without installation.",
  },
  {
    id: "ubuntu",
    name: "Ubuntu / Debian",
    ...
    description:
      "Native .deb package for Ubuntu, Debian, and Linux Mint. Installs with a double click.",
  },
];
      ...
      <div className="relative max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-lg mx-auto">
            Take your AI assistant everywhere. Available for Android, Windows,
            and Linux.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            {features.map((f, i) => (
              <div
                key={i}
                className="flex items-center gap-2 text-sm text-gray-400 bg-[#0e0e0e] border border-[#1a1a1a] rounded-full px-4 py-2"
              >
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-16">
          {platforms.map((platform) => (
            ...
            >
              {/* Icon */}
              <div
                className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${platform.color} flex items-center justify-center mb-4 shadow-lg`}
              ...
              <p className="text-gray-500 text-sm mt-2 mb-5 flex-1">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <ol className="space-y-1.5 text-sm text-gray-500">
                ...
                <li className="font-mono text-xs bg-[#111] px-2 py-1 rounded">
